...
/*
 * Fp12 — degree-12 extension of Fp via  x^12 - 18*x^6 + 82 = 0
 *
 ...
 *
 * Serialisation: fp12_to_bytes writes [coeff[0]..coeff[11]], 32 bytes each,
...
/* Total size: 12 Fp = 12 × 32 = 384 bytes — indices 0..11 accessible
 * as ((Fp*)fp12_ptr)[0..11] */
