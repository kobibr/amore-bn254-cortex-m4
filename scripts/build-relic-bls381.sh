...
#                   with the generic C backend (easy) for BLS12-381.
#                   No ARM hand-tuned assembly exists in upstream RELIC
#                   for FP_PRIME=381 — easy is the only portable option.
#
#  Output: <project root>/relic_install_bls381/lib/librelic_s.a
#          <project root>/relic_install_bls381/include/relic/*.h
#
#  Key properties:
...
RELIC_BUILD="${PROJECT_ROOT}/relic_build_bls381"
RELIC_INSTALL="${PROJECT_ROOT}/relic_install_bls381"
...
echo "  Curve:    BLS12-381  |  Pairing: Optimal Ate, k=12"
echo "  ARITH:    easy  (GENERIC C — no ARM asm for FP_PRIME=381 upstream)"
