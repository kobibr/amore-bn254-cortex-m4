...
#
#  Output: <project root>/relic_install_bn254_easy/lib/librelic_s.a
#          <project root>/relic_install_bn254_easy/include/relic/*.h
#
#  Key properties:
...
RELIC_BUILD="${PROJECT_ROOT}/relic_build_bn254_easy"
RELIC_INSTALL="${PROJECT_ROOT}/relic_install_bn254_easy"
